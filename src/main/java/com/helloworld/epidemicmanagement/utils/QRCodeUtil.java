...
public class QRCodeUtil {
    ...
    public static void createCodeToOutputStreamWithColor(String content, OutputStream outputStream, Color color) {
        try {
            FRONT_COLOR = Integer.decode(toHexFromColor(color));
            if (StringUtils.isBlank(content)) {
                return;
            }
            content = content.trim();
